...
class SubItensList extends GetView<ProductDetailsControllerImp> {
  const SubItensList({super.key});
                  ...
                  children: [
                    ...List.generate(controller.subitems.length, (index) => Container(
                      ...
                      child:  Text(
                        ...
                        style: TextStyle(
                            color:  controller.subitems[index]['active'] == "1" ? Colors.white : AppColor.fourthColor, fontWeight: FontWeight.bold),
                      ),
                    ),)
                  ],
                );
